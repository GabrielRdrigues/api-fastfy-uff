...
$ git clone [https://github.com/GabrielRdrigues/pokemanager-api.git](https://github.com/GabrielRdrigues/pokemanager-api.git)
...
Desenvolvido por Gabriel Rodrigues Marques Valim
